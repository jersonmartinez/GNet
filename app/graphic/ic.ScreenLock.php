<?php include (PD_CTL_PHP."/ic.CalcDate.php"); ?>
...
<div class="modal fade" id="ValidationProblemUser" tabindex="-1" role="dialog" aria-labelledby="ModalOtherDialogConfirmData" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="ModalOtherDialogConfirmData">Confirmación de los datos</h4>
      </div>
